...
let fn =
    '../assets/fonts/helvetica_bold.otf'
...
async function getEducation() {
  formStore.itemsEdu.forEach(el => {
    arrayData.value.push(
        ...
        {
          text: el.school + ' | ' + el.city,
          fontSize: 12,
        },
        {
          text: el.startDate + ' - ' + el.endDate,
          fontSize: 10,
          margin: [0, 0, 0, 20]
        },
    )
...
async function exportPdf(template) {
  let docDefinition = {
    ...
    //         stack: [
    //           {
    //             text: ' formStore.itemsBio[0].firstName',
    //             fontSize: 16,
    //             //  bold: true
    //           },
    //           {
    ...
    //   },
    //   {
    //     text:'Develop targeted outreamplement effective company policies to ensure that all practices comch practices to increase minority recruitment and ensure compliance with affirmative ac Develop targeted outreach practices to incremplement effective company policies to ensure that all practices comase minority recruitment and ensure compliance with affirmative ac',
    //     margin: [0, 0, 0, 10],
    //   },
    //   {
    //     columns: [
    ...
    //       {
    //         margin: [0, 12, 0, 0],
    //         svg: '<svg width="1000" height="10" viewBox="0 0 1000 10">   <line x1="0" y1="0" x2="446" y2="0" stroke="black" stroke-width="1" /></svg>'
    //       },
    //     ],
    //     margin: [0, 0, 0, 0],
    //   },
    ...
    //         width: '*',
    //         alignment: 'right',
    //         //  stack: [await getEducation()],
    //         stack: [
    //           {
    //             text: 'Master in Business Studies',
    //             bold: true,
    //             fontSize: 12,
    //           },
    //           {
    //             text: 'High School Moscow | Moscow',
    //             fontSize: 10,
    //           },
    //         ],
    //       },
    ...
    //       {
    //         margin: [0, 12, 0, 0],
    //         svg: '<svg width="1000" height="10" viewBox="0 0 1000 10">   <line x1="0" y1="0" x2="363" y2="0" stroke="black" stroke-width="1" /></svg>'
    //
    //       },
    //     ],
    //     margin: [0, 20, 0, 0],
    ...
    //           },
    //           {
    //             text: 'Jim\'s Widget Factory, Plano, TX',
    //             fontSize: 10,
    //             margin: [0, 0, 0, 5],
    //           },
    //           {
    ...
    //       {
    //         margin: [0, 12, 0, 0],
    //         svg: '<svg width="1000" height="10" viewBox="0 0 1000 10">   <line x1="0" y1="0" x2="473" y2="0" stroke="black" stroke-width="1" /></svg>'
    //
    //       },
    //     ],
    //     margin: [0, 20, 0, 0],
    ...
    //     ul: [
    //       {
    //         text: 'Implement effective',
    //         margin: [0, 0, 0, 5]
    //       },
    //       {
    //         text: 'satisfaction to ',
    //         margin: [0, 0, 0, 5]
    //       },
    //       {
    //         text: 'Develop s',
    ...
    //       {
    //         margin: [0, 12, 0, 0],
    //         svg: '<svg width="1000" height="10" viewBox="0 0 1000 10">   <line x1="0" y1="0" x2="440" y2="0" stroke="black" stroke-width="1" /></svg>'
    //
    //       },
    //     ],
    //     margin: [0, 20, 0, 0],
        ...
        columns: [
          {
            ...
            stack: [
              ...
              {
                margin: [0, 0, 0, 0],
                svg: '<svg width="1000" height="10" viewBox="0 0 1000 10">   <line x1="0" y1="0" x2="150" y2="0" stroke="black" stroke-width="1" /></svg>'
              },
              {
                columns: [
                  {
          ...
          // second column
          {
            stack: [
              ...
              {
                margin: [0, 0, 0, 0],
                svg: '<svg width="1000" height="10" viewBox="0 0 1000 10">   <line x1="0" y1="0" x2="350" y2="0" stroke="black" stroke-width="1" /></svg>'
              },
              {
                text: 'Develop targeted outreamplement effective company policies to ensure that all practices comch practices to increase minority recruitment and ensure compliance with affirmative ac Develop targeted outreach practices to incremplement effective company policies to ensure that all practices comase minority recruitment and ensure compliance with affirmative ac',
                width: 'auto',
...
<template>
  ...
  <iframe :src="pdfData" height="100%" style="overflow: auto;" type="application/pdf" width="100%">
  </iframe>
</template>
